...
const code = `import { tradingPairRegistry } from './TradingPairRegistry';
...
`;
fs.writeFileSync('src/services/market/TickerService.ts', code);
console.log("Updated TickerService.ts");
