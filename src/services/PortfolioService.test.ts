...
describe('PortfolioService (PNL and Valuation)', () => {
  ...
  it('should calculate initial valuation correctly', async () => {
    ...
    const stats = await portfolioSvc.getPortfolioStats('demo-user-1');
  ...
  it('should calculate cost basis and unrealized PNL on BUY', async () => {
    ...
    tradeSvc.recordTrade({
      orderId: '1', accountId: 'demo-user-1', symbol: 'BTCUSDT', side: 'BUY', price: '50000', quantity: '0.1'
    });
  ...
  it('should calculate realized PNL on SELL', async () => {
    ...
    tradeSvc.recordTrade({
      orderId: '1', accountId: 'demo-user-1', symbol: 'BTCUSDT', side: 'BUY', price: '50000', quantity: '0.2'
    });
    ...
    tradeSvc.recordTrade({
      orderId: '2', accountId: 'demo-user-1', symbol: 'BTCUSDT', side: 'SELL', price: '70000', quantity: '0.1'
    });
  ...
  it('should track locked funds in total balance', async () => {
    ...
    await orderSvc.placeOrder({
      id: 'ord-1', accountId: 'demo-user-1', symbol: 'BTCUSDT', side: 'BUY', type: 'LIMIT', price: '40000', quantity: '0.1', status: 'PENDING', createdAt: Date.now(), updatedAt: Date.now()
    });
