...
export function TradeHistory() {
  ...
  const sortedTrades = [...filteredTrades].sort((a, b) => b.createdAt - a.createdAt);
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <div className="grid grid-cols-2 gap-y-4 gap-x-8 mb-6">
                ...
                <div>
                  ...
                  <div className="text-white text-sm">{new Date(selectedTrade.createdAt).toLocaleString()}</div>
                </div>
