...
export function OrderHistory() {
  ...
  const sortedOrders = [...filteredOrders].sort((a, b) => {
    const timeA = a.completedAt || a.updatedAt || a.createdAt;
    const timeB = b.completedAt || b.updatedAt || b.createdAt;
    return timeB - timeA;
  });
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  ...
                  <div className="text-gray-500 text-xs mt-1">
                    {new Date(o.completedAt || o.updatedAt).toLocaleString()}
                  </div>
                </div>
              </div>
            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <div className="grid grid-cols-2 gap-y-4 gap-x-8 mb-6">
                ...
                <div>
                  ...
                  <div className="text-white text-sm">{new Date(selectedOrder.createdAt).toLocaleString()}</div>
                </div>
                <div>
                  <div className="text-gray-500 text-xs mb-1">Completed At</div>
                  <div className="text-white text-sm">{selectedOrder.completedAt ? new Date(selectedOrder.completedAt).toLocaleString() : new Date(selectedOrder.updatedAt).toLocaleString()}</div>
                </div>
              </div>
                    ...
                    {orderFills.map((fill) => (
                      <div key={fill.id} className="bg-gray-800 p-3 rounded text-sm flex flex-col gap-1">
                        ...
                        <div className="flex justify-between text-xs text-gray-500 mt-1">
                          ...
                          <span>{new Date(fill.createdAt).toLocaleString()}</span>
                        </div>
